            ...
            view: function() {
                ...
                return m("table",
                        m("tbody", t.users.filter(x=> {x.idx=i++; return ufilter(x)} ).map(x => {
                            return m("tr", [
                                m("td",
                                    m(pol.ui.removeEdit, {remove: pol.ui.apply(remove,x.idx), edit: pol.ui.apply(edit, x.idx)})),
                                m("td", x.ident),
            ...
            view: function() {
                return m("div#userEdit", [
                    ...
                    m("div.field",
                        ...
                        m(pol.ui.textInput, { id:"userId", value: t.ident, size: 16,
                            maxLength:25, regex: /.*/i })),

                    m("div.field",
                        m("span.xsleftlab", {title: "HAM radio (APRS) callsign"}, "Callsign:"),
                        m(pol.ui.textInput, { id: "callsign", value: t.callsign, size: 16,
                            maxLength: 32, regex: /[A-Z0-9\-]*/i })),

                    m("div.field",
                        m("span.xsleftlab", "Name:"),
                        m(pol.ui.textInput, { id: "name", value: t.name, size: 25,
                            maxLength: 32, regex: /.*/i })),

                    m("div.field",
                        m("span.xsleftlab", "Passwd:"),
                        m(pol.ui.textInput, { id: "passwd", value: t.passwd, size: 25,
                            maxLength: 32, regex: /.*/i })),

                    m("div.field",
                        m("span.xsleftlab", {title: "Primary Group"}, "Group:"),
                        m(t.groups), m("span#selGroup", ""+t.selGroup), pol.ui.nbsp,
                    ),
                    m("div.field",
                        m("span.xsleftlab", {title: "Secondary group"}, "Alt group:"),
                        m(t.agroups), m("span#selAGroup", ""+t.selAGroup), pol.ui.nbsp,
                    ),

                    m("div.field",
                        m("span.xsleftlab", "Access:"),
                        m(pol.ui.checkBox, {id: "acc_admin", onclick: toggleAdmin, checked: t.admin,
                            title: "Administrator (super user level)" }, "Admin"), pol.ui.nbsp,
                        m(pol.ui.checkBox, {id: "acc_susp", onclick: toggleSuspend, checked: t.suspend,
                            title: "User access is suspended (no login)" }, "Suspend (U)"), pol.ui.nbsp,
                        m(pol.ui.checkBox, {id: "acc_susp", onclick: toggleHideSuspend, checked: t.hidesuspend },
                            "Hide suspended"),
