            ...
            view: function() {
                return m("div#serverConfig", [
                    ...
                    m("div.field",
                        ...
                        m(pol.ui.textInput, { id:"mycall", value: t.mycall, size: 10,
                            maxLength:16, regex: /[A-Z0-9\-]*/i })), pol.ui.br,

                    m("div.field",
                        m("span.wleftlab", "Igate:"),
                        m(pol.ui.checkBox, {id: "rfgate_allow", onclick: toggleIgate, checked: t.rfgate_on,
                            title: "RF/Internet gateway (igate)" }, "Activate") ),

                    m("div.field",
                        m("span.wleftlab", "Igating to RF:"),
                        m(pol.ui.checkBox, {id: "rfgate_allow", onclick: toggleRfgate, checked: t.rfgate_allow,
                            title: "Allow igating to RF" }, "Activate"), pol.ui.nbsp,
                        m(pol.ui.checkBox, {id: "obj_rfgate", onclick: toggleObjRfgate, checked: t.obj_rfgate,
                            title: "Allow igating to RF for objects" }, "RF igating for object") ),

                     m("div.field",
                        m("span.wleftlab", "Range objects:"),
                        m(pol.ui.textInput, { id:"igate_range", value: t.igate_range, size: 6,
                            maxLength:6, regex: /0-9]*/i })),

                    m("div.field",
                        m("span.wleftlab", "Igate digi path:"),
                        m(pol.ui.textInput, { id:"ig_digipath", value: t.igate_path, size: 25,
                            maxLength:32, regex: /a-zA-Z0-9\,\-]*/i })),
                    m("div.field",
                        m("span.wleftlab", "Messages digi path:"),
                        m(pol.ui.textInput, { id:"ig_msgpath", value: t.msg_path, size: 25,
                            maxLength:32, regex: /a-zA-Z0-9\,\-]*/i })),
                    m("div.field",
                        m("span.wleftlab", "Objects digi path:"),
                        m(pol.ui.textInput, { id:"ig_objpath", value: t.obj_path, size: 25,
                            maxLength:32, regex: /a-zA-Z0-9\,\-]*/i })),
                    m("div.field",
                        m("span.wleftlab",
                            {title: "Messages with DEST matching this expression will be sent on RF"},
                            "Always send on RF:"),
                        m(pol.ui.textInput, { id:"ig_alwaysrf", value: t.msg_alwaysrf, size: 25,
                            maxLength:32, regex: /.*/i })), pol.ui.br,

                    m("div.field",
                        m("span.wleftlab", "Remote control:"),
                        m(pol.ui.checkBox, {id: "remotectl_on", onclick: toggleRemotectl, checked: t.remotectl_on,
                            title: "Coordinate with other server-instances over APRS" }, "Activated") ),
                    m("div.field",
                        m("span.wleftlab",
                           {title: "Radius (km) in which we want to receive item-updates"},
                           "Range updates:"),
                        m(pol.ui.textInput, { id:"rctl_range", value: t.rctl_range, size: 6,
                            maxLength:6, regex: /0-9]*/i })),
                    m("div.field",
                        m("span.wleftlab",
                           { title: "Callsign of another Polaric Server instance" }, "RC server:"),
                        m(pol.ui.textInput, { id:"rctl_server", value: t.rctl_server, size: 10,
                            maxLength:16, regex: /a-zA-Z0-9\-]*/i })),
                    m("div.field",
                        m("span.wleftlab", "Authentication key:"),
                        m(pol.ui.textInput, { id:"rctl_key", value: t.rctl_key, size: 25,
